...
class Visitor {
    ...
    public function Display_All_Visitors(){
        ...
        $sql = "SELECT Visitor.visitor_id, Visitor.v_fname, Visitor.v_lname, Visitor.relationship, Visitor.prisoner_name,Visitor.time_of_visit,Visitor.date_of_visit FROM Visitor";
