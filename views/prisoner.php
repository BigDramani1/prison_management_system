                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"> <p ><?php if(mysqli_num_rows($countRemand) !== null){
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><p ><?php if(mysqli_num_rows($countConvict) !== null){
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" data-toggle ="table" data-show-toggle="true" data-toolbar="#toolbar" data-show-fullscreen="true" data-pagination-pre-text="Previous">
                                    ...
                                    <?php
                                        ...
                                        ?><?php
                                                echo'
                                                <tr>
                                                    <td>'.$prisoner['Prisoner_fname'].'</td>
                                                    <td>'.$prisoner['Prisoner_lname'].'</td>
                                                    <td>'.$prisoner['Marital_Status'].'</td>
                                                    <td>'.$prisoner['Sex'].'</td>
                                                    <td>'.$prisoner['Prisoner_status'].'</td>
                                                    <td>'.$prisoner['Prison_name'].'</td>
                                                    <td>'.'<a class="btn btn-primary" href="./viewPrisoner.php?id='.$prisoner['Prisoner_id'].'" role="button"><i class="fas fa-eye"></i></a> <a class="btn btn-success" href="../actions/updatePrisoner.php?id='.$prisoner['Prisoner_id'].'" role="button"><i class="fas fa-edit"></i></a>'.'</td>
                                                </tr>
