...
$countEmployees = "SELECT * FROM Employees";

//Query the number of visits in the current month
$countVisits = "SELECT * FROM Visitor WHERE MONTH(date_of_visit) = MONTH(CURRENT_DATE())";


//Query the number of current prisons 
$countPrison = 'SELECT DISTINCT Prison_name FROM Prisoner';
...
//Executing the query
$resultPrisons = $db->connect()->query($countPrison);
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><br/><?php if(mysqli_num_rows($resultPrisons) !== null){
                                        $number = mysqli_num_rows($resultPrisons);
                                        echo "<p style='text-align:center'><b>".$number."</b></p>";
                                    }else{
                                        echo 0;
                                    }   
